...
public class adminpassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(password, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       if( password.getText().equals("admin")){
          ...
          GradingSystem tR = new  GradingSystem();
            tR.setVisible(true);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(null,"Code error:"," Invalid!",2);
        }
